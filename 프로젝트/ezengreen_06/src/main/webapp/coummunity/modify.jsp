...
String kind    = request.getParameter("bkind");
...
<form id="select_form" name="select_form" enctype="multipart/form-data" action="modifyok.jsp?no=<%= bno %>&page=<%= nowpage %>" method="post" onsubmit="return submitPost();">
	...
	<input type="hidden" id="bkind" name="bkind" value="C">
		<tr>
			<td colspan="5" align="left">
				<b style="float:left; font-size: 14pt; font-weight: 900;">&nbsp;자유게시판 - 글수정</b>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="4" align="left">
				<input type="text" id="title" name="title" style="width: 98%" value="<%= bvo.getBtitle() %>">
			</td>
		</tr>
		<tr>
			<td width="75px">내용 :</td>
