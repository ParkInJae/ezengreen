...
<form name="view" id="view" method="post">
	...
	<table border="0" width="100%" height="430px" style="text-align:center;"  class="maintable">
		...
		<tr class="gray">
			<td colspan="5" height="20px" style="padding: 0;">
				<table border="0" style=" width:100%; border-spacing: 0; text-align:left; ">
					<td class="asd" width="80px">&nbsp;&nbsp;<%= bvo.getUname() %></td>
		...
		<tr>
			...
			<td colspan="3"><input type="text" id="replyText" onkeyup="enterkey(event)" name="replyText" style="width:98%" placeholder="내용을 입력해주세요."></td>
