...
<table border="0" width="100%" height="430px" class="maintable">
	<tr>
		<td>
			<b style="float:left; font-size: 14pt; font-weight: 900;">갤러리</b>
		</td>
	...
	<%
		...
		for(BoardVO vo : list)
		{
			...
			%>		
			<td width="225px" height="180px" style="background-color: white;">
		...
		if(nowpage == maxpage && remainingRows != 0 && remainingRows != 6 && remainingRows < 3)
		{
		    for(int j = 0; j < remainingRows; j++)
		    {
				%>
		        <td style="width:225px; height:165px;"><div class="gsize"></div></td>
				<%
		    }
		    // 남은 행이 4개 이상인 경우에만 <hr> 추가
		    if(remainingRows > 3)
		    {
				%>
		    </tr>
		...
		}else if(nowpage == maxpage && remainingRows >= 3 && remainingRows != 6)
		{
			 for(int j = 0; j < remainingRows-3 ; j++)
		    {
				%>
		        <td style="width:225px; height:165px;"><div class="gsize"></div></td>
				<%
